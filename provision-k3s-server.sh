...
# install k3s.
# see server arguments at e.g. https://github.com/rancher/k3s/blob/v1.18.10+k3s2/pkg/cli/cmds/server.go#L71
...
# e.g. s1     Ready    master   3m    v1.18.10+k3s2
...
# see https://github.com/rancher/k3s/blob/v1.18.10+k3s2/scripts/download#L16
...
# NB the default users are generated at https://github.com/rancher/k3s/blob/v1.18.10+k3s2/pkg/daemons/control/server.go#L436
#    and saved at /var/lib/rancher/k3s/server/cred/passwd
mkdir -p /vagrant/tmp
python3 /vagrant/certs_dump.py
